...
@AllArgsConstructor
@Builder
@Schema(description = "제스처 + 루틴 응답 DTO")
public class GestureWithRoutineResponse {
	...
	@Schema(description = "루틴 ID (연결된 루틴이 없는 경우 null)", example = "1")
	private Long routineId;

	@Schema(description = "루틴 이름 (연결된 루틴이 없는 경우 null)", example = "수면중")
